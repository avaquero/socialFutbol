					...
					$.each(publicacion, function() {
						...
						if (login == 1) {
							if (imatge) {
								...
								'<span class="glyphicon glyphicon-edit"></span> Comenta</button><br/><br/>' + '</div>' + 
								'</div>' + '</div>');
							} else {
								$('#publicacions').append('<div class="col-md-12">' + '<div class="panel panel-primary">' + '<div class="panel-heading">' + dh + '</div>' + '<div class="panel-body"><p align="justify">' + text + 
								'</p><a href="https://twitter.com/share" class="twitter-share-button" data-related="avaquero30" data-url="http://www.socialfootball.cat/perfil/publicacio/' + id + '" data-lang="ca" data-size="large">Tuiteja</a>' +
								'</div>' + 
								'<div class="panel-footer" id="pub' + id + '">' + '<button class="btn btn-info" onclick="Comentar(' + id + ')" data-target="#coment" data-toggle="modal">' + '<span class="glyphicon glyphicon-edit"></span> Comenta</button><br/><br/>' + '</div>' + '</div>' + '</div>');
							}
						} else {
							if (imatge) {
								$('#publicacions').append('<div class="col-md-12">' + '<div class="panel panel-primary">' + '<div class="panel-heading">' + dh + '</div>' + '<div class="panel-body"><p><a href="/media/' + imatge + '"><img class="img-responsive" src="/media/' + imatge + '" width="200px" height="200px" alt="Imatge publicacio" /></a></p><p align="justify">' + text + 
								'</p><a href="https://twitter.com/share" class="twitter-share-button" data-related="avaquero30" data-url="http://www.socialfootball.cat/perfil/publicacio/' + id + '" data-lang="ca" data-size="large">Tuiteja</a>' +
								'</div>' + 
								'<div class="panel-footer" id="pub' + id + '">' + '</div>' + '</div>' + '</div>');
							} else {
								$('#publicacions').append('<div class="col-md-12">' + '<div class="panel panel-primary">' + '<div class="panel-heading">' + dh + '</div>' + '<div class="panel-body"><p align="justify">' + text + 
								'</p><a href="https://twitter.com/share" class="twitter-share-button" data-related="avaquero30" data-url="http://www.socialfootball.cat/perfil/publicacio/' + id + '" data-lang="ca" data-size="large">Tuiteja</a>' +
								'</div>' + 
